...
PM_START_TEXT = """
Hi. This is simple Group Manager Bot.
Owner : @J0hnMilt0n
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://t.me/+6Qw3MfloCixjNGY1")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/+6Qw3MfloCixjNGY1")],
                     [InlineKeyboardButton(text="👨‍💻 Make", url="https://t.me/+6Qw3MfloCixjNGY1"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
